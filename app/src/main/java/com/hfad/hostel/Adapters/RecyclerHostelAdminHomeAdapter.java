...
public class RecyclerHostelAdminHomeAdapter extends RecyclerView.Adapter<RecyclerHostelAdminHomeAdapter.viewHolder> implements Filterable {
    ...
    public RecyclerHostelAdminHomeAdapter(List<Owner> list, Context mCtx) {
        this.list = list;
        this.mCtx = mCtx;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mCtx).inflate(R.layout.sample_recycler_view_admin_home,parent,false);
